...
async function seed() {
  ...
  const sampleEvents = [
    ...
    },
    {
      ...
      entities: [
        { type: 'PERSON', textHash: 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', confidence: 0.95, length: 10, start: 42, end: 52, source: 'regex' },
        { type: 'ORGANIZATION', textHash: '2c26b46b68ffc68ff99b453c1d30413413422d706483bfa0f98a5e886266e7ae', confidence: 0.88, length: 9, start: 78, end: 87, source: 'regex' },
      ],
    ...
    },
    {
      ...
      entities: [
        { type: 'PERSON', textHash: 'a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e', confidence: 0.92, length: 8, start: 15, end: 23, source: 'regex' },
        { type: 'SSN', textHash: '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', confidence: 0.99, length: 11, start: 120, end: 131, source: 'regex' },
        { type: 'MONETARY_AMOUNT', textHash: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855', confidence: 0.85, length: 5, start: 200, end: 205, source: 'regex' },
      ],
    ...
    },
    {
      ...
      entities: [
        { type: 'PERSON', textHash: '4b227777d4dd1fc61c6f884f48641d02b4d121d3fd328cb08b5531fcacdbe514', confidence: 0.97, length: 11, start: 5, end: 16, source: 'regex' },
        { type: 'CREDIT_CARD', textHash: '6b51d431df5d7f141cbececcf79edf3dd861c3b4069f0b11661a3eefacbba918', confidence: 0.99, length: 19, start: 45, end: 64, source: 'regex' },
        { type: 'EMAIL', textHash: '3fdba35f04dc8c462986c992bcf875546257113072a909c162f7e470e581e278', confidence: 0.98, length: 18, start: 100, end: 118, source: 'regex' },
        { type: 'MATTER_NUMBER', textHash: '8d23cf6c86e834a7aa6eded54c26ce2bb2e74903538c61bdd5d2197997ab2f72', confidence: 0.90, length: 10, start: 150, end: 160, source: 'regex' },
      ],
    ...
    },
    {
      ...
      sensitivityLevel: 'medium' as const,
      entities: [
        { type: 'ORGANIZATION', textHash: 'd7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592', confidence: 0.80, length: 15, start: 30, end: 45, source: 'regex' },
        { type: 'IP_ADDRESS', textHash: '6ca13d52ca70c883e0f0bb101e425a89e8624de51db2d2392593af6a84118090', confidence: 0.95, length: 9, start: 80, end: 89, source: 'regex' },
      ],
      action: 'warn' as const,
      captureMethod: 'fetch',
      metadata: { browser: 'Chrome 120' },
    },
    {
      ...
      sensitivityLevel: 'high' as const,
      entities: [
        { type: 'PERSON', textHash: 'a3a2e39cbcde9ee6e8acb4946ef50b0b25e99cb2a2ac4a60e5b6eb9b1e1bf87e', confidence: 0.93, length: 14, start: 10, end: 24, source: 'regex' },
        { type: 'PHONE_NUMBER', textHash: '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', confidence: 0.97, length: 14, start: 55, end: 69, source: 'regex' },
        { type: 'DEAL_CODENAME', textHash: '8bb0cf6eb9b17d0f7d22b456f121257dc1254e1f01665370476383ea776df414', confidence: 0.88, length: 15, start: 100, end: 115, source: 'regex' },
      ],
      action: 'proxy' as const,
      captureMethod: 'dom',
      metadata: { browser: 'Chrome 120' },
    },
    {
      ...
      sensitivityLevel: 'medium' as const,
      entities: [
        { type: 'ORGANIZATION', textHash: '15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225', confidence: 0.85, length: 18, start: 20, end: 38, source: 'regex' },
      ],
      action: 'pass' as const,
      captureMethod: 'fetch',
      metadata: { browser: 'Chrome 120' },
