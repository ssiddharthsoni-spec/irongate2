...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white">
      ...
      {/* ── Nav ─────────────────────────────────────────────────────────── */}
      <nav className="sticky top-0 z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-lg border-b border-gray-100 dark:border-gray-800/50">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-16 md:py-24">
        ...
        <section className="mb-12">
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 mb-6">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-900 text-left">
                  <th className="px-5 py-3 font-semibold text-gray-900 dark:text-white">Tier</th>
                  <th className="px-5 py-3 font-semibold text-gray-900 dark:text-white">Prompts / Month</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                <tr>
                  <td className="px-5 py-3 text-gray-700 dark:text-gray-300">Free</td>
                  <td className="px-5 py-3 text-gray-600 dark:text-gray-400">500</td>
                </tr>
                <tr>
                  <td className="px-5 py-3 text-gray-700 dark:text-gray-300">Pro</td>
                  <td className="px-5 py-3 text-gray-600 dark:text-gray-400">10,000</td>
                </tr>
                <tr>
                  <td className="px-5 py-3 text-gray-700 dark:text-gray-300">Business</td>
                  <td className="px-5 py-3 text-gray-600 dark:text-gray-400">100,000</td>
                </tr>
                <tr>
                  <td className="px-5 py-3 text-gray-700 dark:text-gray-300">Enterprise</td>
                  <td className="px-5 py-3 text-gray-600 dark:text-gray-400">Unlimited (custom pricing)</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <footer className="border-t border-gray-100 dark:border-gray-800/50">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500">&copy; 2026 Iron Gate. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
