...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[#1d1d1f] dark:text-[#f5f5f7]">Settings</h1>
        <p className="text-sm text-[#6e6e73] dark:text-[#86868b] mt-1">Manage your Iron Gate configuration and preferences.</p>
      </div>
            ...
            {settingsTabs.map((tab) => {
              ...
              return (
                <li key={tab.href}>
                  ...
                  >
                    <span className={isActive ? 'text-iron-600 dark:text-iron-400' : 'text-[#86868b] dark:text-[#636366]'}>
                      {tab.icon}
                    </span>
                    <span>{tab.label}</span>
                  </Link>
