...
export const TOPIC_CLUSTERS: TopicCluster[] = [
  ...
  },
  {
    ...
    scoreBoost: 25,
    seeds: [
      'Luminos Financial Group\'s internal probe found that Corvin Hale used his personal trading account (Schwab #4478-2291) to front-run three client trades totaling $12 million. We need to self-report to FI',
      ...
      'Quartzite Mining Corp\'s board member Kavita Neroshan sold 200,000 shares at $42 each three days before the announcement of the environmental contamination. Her broker at Merrill Lynch flagged the trades. Th',
  ...
  },
  {
    ...
    seeds: [
      ...
      'Summit Ventures\' pre-IPO audit revealed that Kavita Neroshan approved $18 million in related-party transactions that were not properly disclosed. The underwriters at Goldman need to be informed, but doin',
  ...
  },
  {
    ...
    seeds: [
      ...
      'The creditor committee for Vexilis Retail Group has rejected the 363 sale proposal from Cerberus at $220M. The secured lenders led by Deutsche Bank want a credit bid at $180M to take control. The com',
    ],
  },
  {
