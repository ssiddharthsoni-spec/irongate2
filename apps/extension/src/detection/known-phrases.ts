...
const TECHNICAL = [
  ...
  'Summary Judgment', 'District Court', 'District Judge',
  'Supreme Court', 'Design Patent', 'Patent Infringement',
  'Motion Summary', 'This Court', 'The Court',
  'Material Fact', 'Class Action', 'United States',
  'Good Faith', 'Fiscal Year', 'Task Force',
  'White Paper', 'Green Card', 'Blue Cross',
  'Red Cross', 'Fair Value', 'Net Worth',
